        ...
        <f:view locale="#{FuelOrderLogBean.locale}">	
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader" class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleEnterOriginLoc}" styleClass="pagetitle"/>
                        ...
                        <tr>
                            ...
                            <td>
                               	<h:inputText id="input1" 
                             			 value="#{FuelOrderLogBean.inputCode}" 
                             			 styleClass="input" /> 
                            </td>
                        </tr>
                ...
                <div class="buttonbar">  
	                 <h:commandButton id="forwardButton" 
	                 				 ...
	                 				 action="#{FuelOrderLogBean.processEnterLoc}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="backButton" 
	                 				 value="#{bundle.ButtonCancel}" 
	                 				 action="#{FuelOrderLogBean.processEnterLocCancel}" 
	                 				 styleClass="commandButton"  />
