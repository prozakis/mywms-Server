        ...
        <f:view locale="#{FuelBean.locale}">	
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader" class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleEnterOrderType}" styleClass="pagetitle"/>
                ...
                <div class="space">
                    ...
                    <table  width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <h:outputLabel value="#{bundle.LabelChooseOrderType}" styleClass="label"/>
                            </td>
                        </tr><tr>
                            <td>
                                <h:selectOneMenu id="orderComboBox"
                                                 value="#{FuelBean.selectedOrderType}" style="width:100%;" >
                                    <f:selectItems value="#{FuelBean.orderTypeList}" />
                                </h:selectOneMenu>
                            </td>
                        </tr>
                ...
                <div class="buttonbar">  
	                 <h:commandButton id="forwardButton" 
	                 				 ...
	                 				 action="#{FuelBean.processEnterOrderType}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="backButton" 
	                 				 value="#{bundle.ButtonCancel}" 
	                 				 action="#{FuelBean.processEnterOrderTypeCancel}" 
	                 				 styleClass="commandButton"  />
