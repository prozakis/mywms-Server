        ...
        <f:view locale="#{FuelBean.locale}">	
            ...
            <h:form id="Form" styleClass="form" >
                ...
                <p id="pHeader" class="pageheader">
                	<h:outputText id="pagetitle" value="#{bundle.TitleFuelOut}" styleClass="pagetitle" />
                ...
                <div class="space">
                    ...
                    <table width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                            	<h:outputLabel id="input1Label" value="#{bundle.LabelEnterVehicle}" styleClass="label" />
                            </td>
                        </tr><tr>
                            <td>
                ...
                <div class="buttonbar">  
	                 <h:commandButton id="forwardButton" 
	                 				 ...
	                 				 action="#{FuelBean.processEnterVeh}" 
	                 				 styleClass="commandButton"  />
	                 				 
	                 <h:commandButton id="backButton" 
	                 				 value="#{bundle.ButtonMenu}" 
	                 				 action="#{FuelBean.processEnterVehCancel}" 
	                 				 styleClass="commandButton"  />
                </div>
            </h:form>
        </f:view> 
