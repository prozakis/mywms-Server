 ...
 */
@Stateless
public class OrderQueryBean extends
		BusinessObjectQueryBean<LOSOrder> implements
		OrderQueryRemote {

	private final static Logger log = Logger.getLogger(OrderQueryBean.class);
	...
	public List<BODTO<LOSOrder>> queryZombies(QueryDetail d)
		...
		b.append(" FROM ");
		b.append(LOSOrder.class.getName());
		b.append(" o  ");
	...
	@Override
	public LOSResultList<LOSOrder> queryByTemplate(QueryDetail detail,
			TemplateQuery query) throws BusinessObjectNotFoundException,
			BusinessObjectQueryException {
//		query.addWhereToken(new TemplateQueryWhereToken(TemplateQueryWhereToken.OPERATOR_EQUAL, "orderType", OrderType.TO_CUSTOMER));
		return super.queryByTemplate(detail, query);
	}
